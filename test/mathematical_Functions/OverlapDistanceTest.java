...
public class OverlapDistanceTest {
    ...
    @Test public void testComputeFixedPointRadians() {
        ...
        assertEquals(instance2.computeFixedPointRadians(1.0E-7), instance1.computeFixedPointRadians(1.0E-7), 1.0E-6);
    }
    ...
    public void testComputeOverlapDistance() {
        ...
        OverlapDistance instance1 = new OverlapDistance();
        Incarnation2 instance2 = new Incarnation2();
        assertEquals(instance2.computeOverlapDistance(2,1.0E-7),instance1.computeOverlapDistance(2,1.0E-7), 1.0E-6);
    }
